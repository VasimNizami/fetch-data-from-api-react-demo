...
const Navbar = () => {
    return <nav className="relative flex w-full flex-nowrap items-center justify-between bg-black py-2 shadow-dark-mild lg:flex-wrap lg:justify-start lg:py-4"
            data-twe-navbar-ref>
            <div className="flex w-full flex-wrap items-center justify-between px-3">
                <div className="mx-2">
                    <a className="text-xl text-neutral-100" href="#">Dashboard</a>
                </div>
                <button
